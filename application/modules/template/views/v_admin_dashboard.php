    ...
    <div>
        ...
        <div id="header-topbar-option-demo" class="page-header-topbar">
            ...
            <div class="navbar-header">
                ...
                <a id="logo" href="index.html" class="navbar-brand"><span class="fa fa-rocket"></span><span class="logo-text">Elbo CMS</span><span style="display: none" class="logo-text-icon">µ</span></a></div>
        ...
        <div id="wrapper">
            ...
            <!--END SIDEBAR MENU-->
                ...
                <div id="footer">
                    <div class="copyright">
                        <a href="http://themifycloud.com"><?php echo date("Y"); ?>© Elbo CMS</a></div>
                </div>
                <!--END FOOTER-->
            </div>
            <!--END PAGE WRAPPER-->
